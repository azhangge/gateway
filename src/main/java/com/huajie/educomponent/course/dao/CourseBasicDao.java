 ...
 */
@Repository
public interface CourseBasicDao extends JpaRepository<CourseBasicEntity, String> {
...
//    PageResult<CourseBasicEntity> getCourseBySort(Integer sortType, int pageIndex, int pageSize);
